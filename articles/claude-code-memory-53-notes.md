...
- 実体のメモリ **53本**、合計 **238,518字**
- 1本あたり平均 4,500字。最大は 25,290字、最小は 567字
- 索引の MEMORY.md は **10,946字**、53行
...
53本で238,518字ありますが、セッションのたびに読まれるのは索引の MEMORY.md だけです。10,946字。**本体の4.6%しか常時読まれていません。**
...
**この記事に書いた数字も、全部この場で数え直したものです。** 53本、238,518字、14本、23箇所。
...
最大のメモリは25,290字あります。1本のプロジェクトについて4か月ぶん追記し続けた結果です。
...
25,290字を1行で表そうとすると、こうなります。**「・」で区切って足していくしかなくなり、どれが今も有効なのかが行から読み取れません。** 開けば分かるのですが、開くかどうかを判断するための1行なので、判断ができなくなっています。
